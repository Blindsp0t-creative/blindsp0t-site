...
blocks:
- type: text
  html: 'A l''occasion de l''anniversaire des 150 ans des relations diplomatiques Suisse - Japon, Beam''Art a travaillé avec l''artiste Lisa Ishii Akari (I.C.O.N.) et Mokoto Ishii (MOTOKO ISHII LIGHTING DESIGN) sur le projet TranJS.<br>
    ...
    A projection on the ground of 15m diameter reacting in real time to the position of the spectators was set up for this occasion.'
- type: video
  src: https://player.vimeo.com/video/125127074
  w: '960'
  h: '540'
- type: image
